import { _decorator, Component, Node, Prefab, instantiate, SpriteFrame, Sprite, math, view, Label, AudioSource, director } from 'cc';const { ccclass, property } = _decorator;
...
export class GameManager extends Component {
    ...
    public onCandyDropped() {
        ...
        if (this.lives <= 0) {
            ...
            // FIX 2: Cho hệ thống delay đúng 0.1 giây (100ms) để tiếng Miss kịp vang lên rồi mới đóng băng
            setTimeout(() => {
                director.pause();
            }, 100);
        }
